...
Penpot SaaS 是当前桌面壳层重设计已批准的高保真评审载体，通过 Penpot 官方托管的 Remote MCP 访问。已完成的 OpenDesign HTML 产物仅作为低保真探索与交互证据，不是高保真事实来源。被采纳的 Penpot 结果必须回写本文档和仓库 Token 定义；外部设计工作区不得成为并行事实来源。
